                    ...
                    <div className="form-group">
                        ...
                        <div className="file-input-wrapper">
                            <input
                                ...
                                style={{ display: 'none' }}
                            />
                            <label htmlFor="images" className="premium-file-uploader">
                                ...
                                <span className="uploader-primary-text">Drag and Drop</span>
                                <span className="uploader-separator-text">or</span>
                                <span className="uploader-browse-btn">Browse file</span>
                            </label>
                        </div>
